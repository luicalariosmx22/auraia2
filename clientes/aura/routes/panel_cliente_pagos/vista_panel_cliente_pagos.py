...
# 👉 Código corregido: solo una ruta definida, sin duplicados
...
def panel_cliente_pagos():
    ...
    # Filtrar solo recibos y facturas (no presupuestos)
    pagos = [p for p in pagos if p.get("formato") in ("recibo", "factura")]
